...
use crate::{AnimationList, GraphicsBundle, GraphicsState, GreenLightingBundle, HahaBundle, Item, ItemBundle, PlatformBundle, Player, PlayerBundle, PlayerGraphicsBundle, StateAnimation};
...
impl Plugin for LevelPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(LdtkPlugin)
            ...
            .add_systems(Update, process_item);
    }
}
